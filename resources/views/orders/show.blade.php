    ...
    <section class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            ...
            <div class="mt-3 flex items-center gap-3">
                <span
                    class="rounded-full px-3 py-1 font-extrabold uppercase tracking-[0.24em] ring-1 {{ $order->status->badgeClasses() }}">
                    {{ $order->status->label() }}
                </span>
            ...
            @foreach ($order->items as $item)
                <article class="panel flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">{{ $item->quantity }} x Rp
                            {{ number_format((float) $item->unit_price, 0, ',', '.') }}</p>
                    </div>
                    <p class="font-display text-2xl text-red-600">Rp
        ...
        <aside class="space-y-4">
            <div class="panel">
                ...
                <div class="space-y-3 text-sm leading-6 text-slate-600">
                    ...
                    @endif
                    <p><span class="text-slate-500">Untuk pengaktifan garansi, silahkan konfirmasi dan kirim video unboxing
            ...
            <div class="panel">
                ...
                <div class="space-y-3 text-sm text-slate-600">
                    ...
                    <div class="flex items-center justify-between">
                        <span>Total</span>
                        <span class="font-display text-2xl text-red-600">Rp
